...
export function ProductBrand({
  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      <div
        className={cn(
          "relative flex items-center justify-center overflow-hidden rounded-[22px] border bg-[radial-gradient(circle_at_24%_18%,rgba(59,130,246,0.34),transparent_30%),radial-gradient(circle_at_76%_74%,rgba(20,184,166,0.24),transparent_34%),linear-gradient(145deg,rgba(7,15,36,0.98),rgba(9,58,80,0.98))] shadow-[0_20px_44px_rgba(8,25,48,0.26)]",
          compact ? "h-11 w-11" : "h-12 w-12",
          sidebar ? "border-white/14" : "border-slate-200/80"
        )}
      >
        <svg viewBox="0 0 52 52" fill="none" className="h-7 w-7" aria-hidden="true">
          <path
      ...
      {!compact ? (
        <div className="space-y-0.5">
          <div className={cn("text-[1.02rem] font-semibold tracking-[-0.05em]", sidebar ? "text-slate-50" : "text-slate-950")}>
            Sentryn
          </div>
          <div className={cn("text-[11px] font-medium uppercase tracking-[0.24em]", sidebar ? "text-cyan-100/56" : "text-slate-500")}>
