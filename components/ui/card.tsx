...
export function Card({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        "surface-card rounded-[26px] text-card-foreground transition-[box-shadow,border-color] duration-200 ease-out",
        className
      )}
      {...props}
    />
...
export function CardTitle({ className, ...props }: HTMLAttributes<HTMLHeadingElement>) {
  return <h3 className={cn("text-[1.06rem] font-semibold tracking-[-0.03em] text-slate-950", className)} {...props} />;
}
